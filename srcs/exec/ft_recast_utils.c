...
/*   Updated: 2024/10/10 22:24:37 by ahadj-ar         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// 		else
// 			flags |= O_TRUNC;
// 		fd_outfile = open(current->output_file[current->out_index], flags, 0644);
// 		if (fd_outfile == -1)
// 			ft_put_error2(current->output_file[current->out_index], 1);
// 		close(fd_outfile);
// 	}
// }
